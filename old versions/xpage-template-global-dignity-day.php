...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		-->
			...
			<?php if( have_rows('dignity_principles', 11) ): ?>
				<?php while( have_rows('dignity_principles', 11) ): the_row(); ?>			
					<div id="dignity_principles" class="wrap-1300">
						...
						<div id="principles-intro-wrap" class="wrap-700">
							<?php the_sub_field('principles_intro', 11);?>
						</div>
						<div class="dignity-cards-wrap">
							<div class="principle-card" id="one"><div class="number-wrap"><div class="number-bg"><div class="number">1</div></div></div><p><?php the_sub_field('one', 11);?></p></div>
							<div class="principle-card" id="two"><div class="number-wrap"><div class="number-bg"><div class="number">2</div></div></div><p><?php the_sub_field('two', 11);?></p></div>
							<div class="principle-card" id="three"><div class="number-wrap"><div class="number-bg"><div class="number">3</div></div></div><p><?php the_sub_field('three', 11);?></p></div>
							<div class="principle-card" id="four"><div class="number-wrap"><div class="number-bg"><div class="number">4</div></div></div><p><?php the_sub_field('four', 11);?></p></div>
							<div class="principle-card" id="five"><div class="number-wrap"><div class="number-bg"><div class="number">5</div></div></div><p><?php the_sub_field('five', 11);?></p></div>
						</div>
			...
			<?php endif;?>
				...
				<div class="centered gdd-button-wrap">
<!-- 					<a class="button button-black" href="#">Share</a> -->
...
<!-- 					<a class="a2a_dd" href="https://www.addtoany.com/share">Share</a> -->
					...
					if( $link ): ?>								
						<a href="<?php echo $link['url']; ?>"class="button button-clear"><?php echo $link['title']; ?></a>
					<?php endif; ?>



<!-- 					<a class="button button-clear" href="<?php echo get_site_url();?>/our-story">Our Story</a> -->
				</div>
