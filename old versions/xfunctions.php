...
if (isset($id['v'])) {
return '<iframe width="'.$args['width'].'" height="'.$args['height'].'" src="http://www.youtube.com/embed/'.$id['v'].'?rel=0&amp;&showinfo=0;&autohide=0;&modestbranding=1&amp;&nologo=1&amp" frameborder="0" allowfullscreen></iframe>';
}
return $html;
}
