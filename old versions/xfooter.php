...
<?php if(is_page_template('page-template-board-resources.php') || is_page_template('page-template-brand-resources.php') || is_page_template('page-template-inspiration.php') || is_page_template('page-template-organizational-resources.php') || is_page_template('page-template-press.php') || is_page_template('page-template-resources.php') || is_page_template('page-template-teaching-tools.php')):?>	
	<script type="text/javascript">
