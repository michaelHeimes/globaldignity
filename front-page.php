				...
				<div class="hero-bottom">
					...
					<div class="wrap-1300 inner">
						...
						<div class="left">
							...
							<div class="hashtag"><?php the_field('temporary_heading');?></div>
							
							<?php the_field('temporary_copy');?>
							
						</div>
						
						<div class="right">
							<?php 
							$link = get_field('temporary_button_1');
							if( $link ): 
							    $link_url = $link['url'];
							    $link_title = $link['title'];
							    $link_target = $link['target'] ? $link['target'] : '_self';
							    ?>
							    <a class="button button-clear" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
							<?php endif; ?>
							<?php 
							$link = get_field('temporary_button_2');
							if( $link ): 
							    $link_url = $link['url'];
							    $link_title = $link['title'];
							    $link_target = $link['target'] ? $link['target'] : '_self';
