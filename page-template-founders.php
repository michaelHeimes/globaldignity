...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		<?php endif;?>
			...
			<img class="normal-res founders_image" src="<?php the_field('founders_image');?>"/>
			<img class="high-res founders_image" src="<?php the_field('founders_high_resolution_image');?>"/> 
