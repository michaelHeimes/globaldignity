...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<h1 class="centered wrap-700 intro-padded resources_title"><?php the_field('teaching_dignity_title', 'option');?></h1>
		...
		<nav id="teaching-navigation" class="page-navigation">
			<?php
				wp_nav_menu( array(
					'theme_location' => 'teaching-menu',
					'menu_id'        => 'teaching-menu',
